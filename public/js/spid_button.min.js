...
`,document.head.appendChild(style),jQuery&&function(i){function t(t,s){var o=t?i(this):s,n=i(o.attr("spid-idp-button")),a=o.hasClass("spid-idp-button-open");if(t){if(i(t.target).hasClass("spid-idp-button-ignore"))return;t.preventDefault(),t.stopPropagation()}else if(o!==s.target&&i(s.target).hasClass("spid-idp-button-ignore"))return;d(),a||o.hasClass("spid-idp-button-disabled")||(o.addClass("spid-idp-button-open"),n.data("spid-idp-button-trigger",o).show(),p(),n.trigger("show",{spidIDPButton:n,trigger:o}))}function d(t){var d=t?i(t.target).parents().addBack():null;(!(d&&d.is(".spid-idp-button"))||d.is(".spid-idp-button-menu")&&d.is("A"))&&(i(document).find(".spid-idp-button:visible").each(function(){var t=i(this);t.hide().removeData("spid-idp-button-trigger").trigger("hide",{spidIDPButton:t})}),i(document).find(".spid-idp-button-open").removeClass("spid-idp-button-open"))}function p(){var t=i(".spid-idp-button:visible").eq(0),d=t.data("spid-idp-button-trigger"),p=d?parseInt(d.attr("data-horizontal-offset")||0,10):null,s=d?parseInt(d.attr("data-vertical-offset")||0,10):null;0!==t.length&&d&&(t.hasClass("spid-idp-button-relative")?t.css({left:t.hasClass("spid-idp-button-anchor-right")?d.position().left-(t.outerWidth(!0)-d.outerWidth(!0))-parseInt(d.css("margin-right"),10)+p:d.position().left+parseInt(d.css("margin-left"),10)+p,top:d.position().top+d.outerHeight(!0)-parseInt(d.css("margin-top"),10)+s}):t.css({left:t.hasClass("spid-idp-button-anchor-right")?d.offset().left-(t.outerWidth()-d.outerWidth())+p:d.offset().left+p,top:d.offset().top+d.outerHeight()+s}))}i.extend(i.fn,{spidIDPButton:function(p,s){switch(p){case"show":return t(null,i(this)),i(this);case"hide":return d(),i(this);case"attach":return i(this).attr("spid-idp-button",s);case"detach":return d(),i(this).removeAttr("spid-idp-button");case"disable":return i(this).addClass("spid-idp-button-disabled");case"enable":return d(),i(this).removeClass("spid-idp-button-disabled")}}}),i(document).on("click.spid-idp-button","[spid-idp-button]",t),i(document).on("click.spid-idp-button",d),i(window).on("resize",p)}(jQuery);var SPID=function(){var i={path_img:"/public/img/spid",url:"sso_init",eidas:!1},t=function(i){this.config=i};return t.prototype._render=function(i){if(0==$("#spid-button").length){console.warn("Nessun placeholder HTML trovato nella pagina per i pulsanti SPID.");return}let t="";i.eidas&&(t+='<div class="eidas-idp-button-link" data-idp="eidas"><br />                <a href="#" class="italia-it-button italia-it-button-size-m button-eidas" eidas-idp-button="#eidas-idp-button-medium-get" aria-haspopup="false"  aria-expanded="false">                    <span class="italia-it-button-icon"><img src="'+i.path_img+'/ficep-it-eidas-ybw.svg" alt="Accedi con eIDAS" /></span>                    <span class="italia-it-button-text">Login with eIDAS</span>                </a><br />                <div class="text_eidas">                    <a href="#">Sign in with a digital identity<br /> from another European Country</a>                </div><br />            </div>'),t+='<a href="#" class="italia-it-button italia-it-button-size-m button-spid" spid-idp-button="#spid-idp-button-medium-get" aria-haspopup="true" aria-expanded="false">                <span class="italia-it-button-icon"><img src="'+i.path_img+'/spid-ico-circle-bb.svg"  alt="" /></span>                <span class="italia-it-button-text">Entra con SPID</span>            </a>            <div id="spid-idp-button-medium-get" class="spid-idp-button spid-idp-button-tip spid-idp-button-relative">                <ul id="spid-idp-list-medium-root-get" class="spid-idp-button-menu" aria-labelledby="spid-idp">                    <li class="spid-idp-button-link" data-idp="teamsystemid">                        <a href="#"><span class="spid-sr-only">TeamSystem ID</span><img src="'+i.path_img+'/spid-idp-teamsystemid.svg"  alt="TeamSystem ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="arubaid">                        <a href="#"><span class="spid-sr-only">Aruba ID</span><img src="'+i.path_img+'/spid-idp-arubaid.svg"  alt="Aruba ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="infocert">                        <a href="#"><span class="spid-sr-only">Infocert ID</span><img src="'+i.path_img+'/spid-idp-infocertid.svg"  alt="Infocert ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="intesa">                        <a href="#"><span class="spid-sr-only">Intesa ID</span><img src="'+i.path_img+'/spid-idp-intesaid.svg"  alt="Intesa ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="lepida">                        <a href="#"><span class="spid-sr-only">Lepida ID</span><img src="'+i.path_img+'/spid-idp-lepidaid.svg" alt="Lepida ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="namirialid">                        <a href="#"><span class="spid-sr-only">Namirial ID</span><img src="'+i.path_img+'/spid-idp-namirialid.svg"  alt="Namirial ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="poste">                        <a href="#"><span class="spid-sr-only">Poste ID</span><img src="'+i.path_img+'/spid-idp-posteid.svg"  alt="Poste ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="sielte">                        <a href="#"><span class="spid-sr-only">Sielte ID</span><img src="'+i.path_img+'/spid-idp-sielteid.svg"  alt="Sielte ID" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="spiditalia">                        <a href="#"><span class="spid-sr-only">SPIDItalia Register.it</span><img src="'+i.path_img+'/spid-idp-spiditalia.svg"  alt="SpidItalia" /></a>                    </li>                    <li class="spid-idp-button-link" data-idp="tim">                        <a href="#"><span class="spid-sr-only">Tim ID</span><img src="'+i.path_img+'/spid-idp-timid.svg"  alt="Tim ID" /></a>                    </li>                    <li class="spid-idp-support-link">                        <a href="https://www.spid.gov.it">Maggiori informazioni</a>                    </li>                    <li class="spid-idp-support-link">                        <a href="https://www.spid.gov.it/richiedi-spid">Non hai SPID?</a>                    </li>                    <li class="spid-idp-support-link">                        <a href="https://www.spid.gov.it/serve-aiuto">Serve aiuto?</a>                    </li>                </ul>            </div>',$("#spid-button").append(t);var d=$("#spid-idp-list-medium-root-get");setTimeout(function(){},500);for(var p=d.children(".spid-idp-button-link"),s=d.children(".spid-idp-support-link");p.length;)d.append(p.splice(Math.floor(Math.random()*p.length),1)[0]);d.append(s),$(".spid-idp-button-link a").on("click",function(t){t.stopImmediatePropagation(),$(this).attr("disabled","disabled"),t.preventDefault();let d=$(this).parent().attr("data-idp"),p=window.location.origin+"/"+i.url+"?idp="+d;window.location.href=p}),$(".eidas-idp-button-link a").on("click",function(t){t.stopImmediatePropagation(),$(this).attr("disabled","disabled"),t.preventDefault();let d=$(this).parent().attr("data-idp"),p=window.location.origin+"/"+i.url+"?idp="+d;window.location.href=p})},{init:function(d){for(var p in d=JSON.parse(JSON.stringify(d)),i)p in d||(d[p]=i[p]);var s=new t(d);return s._render(d),s}}}();
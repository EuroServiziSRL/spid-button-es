...
jQuery &&
    ...
    function spid_addIdpEntry(data, element,url_da_config) {                  
        ...
        if (element.id.indexOf('get')!== -1 || element.id.indexOf('prof')!== -1) {
            ...
            li.innerHTML = '<a href="'+window.location.origin+'/'+url_da_config+'?idp='+param+'"><span class="spid-sr-only">'+data['organization_name']+'</span><img src="'+data['logo_uri']+'" alt="'+data['organization_name']+'" /></a>';
        };
        element.prepend(li)
    }
